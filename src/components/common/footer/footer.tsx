      ...
      >
        ...
        <div className="relative w-[10.42rem] h-[2.45rem] xl:w-[257px] ">
          <img
            ...
            height={100}
          />
        <p className="max-w-[200px] mt-[-12px] font-unineue text-[12px] text-center text-white">CRECI J-26794</p>
        </div>
      </div>
      <div
        data-aos="fade-up"
        ...
        data-aos-mirror="true"
        data-aos-once="false"
        className="border border-[#803A2C] w-[18.25rem] xl:w-[50%]"
      />
      <div
        data-aos="fade-up"
        data-aos-offset="200"
        ...
        data-aos-mirror="true"
        data-aos-once="false"
        className="font-unineue  text-white text-center text-[12px] space-y-6 sm:text-[14px] xl:px-56"
      >
        ...
        <p className="sm:pt-28 font-light">
