...
const events = [
  {
    title: "CIA ATHLETICA",
    description: "Prepare-se para uma experiência revitalizante com atividades físicas, dicas de nutrição e momentos para saúde do corpo e mente.",
    dates: "08 e 09/03",
  ...
  },
  {
    ...
    description: "Em parceria com chefs especializados, oferecemos uma experiência única de degustação com sabores incríveis e combinações criativas.",
    dates: "15 e 16/03",
    time: "A PARTIR DAS 9H",
  ...
  {
    title: "BAR DE DRINKS",
    description: "Uma noite exclusiva de drinks autorais. Mix e Shake! Bartender convidado, drinks exclusivos e combinações surpreendentes.",
    dates: "22 e 23/03",
    time: "A PARTIR DAS 9H",
  ...
  },
  {
    ...
    description: "Desfrute de uma aula fitness especial e depois de uma massagem relaxante para recuperar energias.",
    dates: "28, 29 e 30/03",
    time: "A PARTIR DAS 9H",
...
const EventSection =  ({ onEventSelect }: { onEventSelect: (data: { name: string; email: string; fone: string; date: string; time: string, title: string }) => void }) => {
  ...
  return (
    <section
      id="event-section"
      className="pt-[7rem] lg:pt-[110px] min-h-screen"
    >
      <div className="relative max-w-[100rem] mx-auto flex justify-around w-full mb-[54px]">
          ...
          <div className="w-full max-w-[65%] sm:max-w-[100%] md:ml-[3rem] ml-2 md:h-full md:max-w-1/2 flex flex-row items-end">
            <div className=" uppercase font-adero text-black text-[12px] sm:text-[14px] md:text-[16px] lg:text-[18px] xl:text-[24px]   md:ml-[0.3rem] lg:ml-[0.5rem] md:p-[4px]">
              <div className="relative">
                ...
                <div className="absolute w-[5rem] sm:w-[12rem] bottom-0 -left-[1.3rem] md:-left-[105px] border-t border-[#803A2B] md:border-[1px] md:w-[13rem] xl:w-[18rem]" />
              </div>
            ...
            <div className="inset-0">
              <div className="absolute h-full top-0 left-[32px] md:left-[62px] xl:left-[91px] border-l-[1px] border-[#803A2B] border-[1px]" />
            </div>
          </div>
        </div>
        <div className="absolute sm:relative top-[-24px] sm:top-0 right-1 w-full  font-unineue text-black sm:items-center md:items-start xl:max-h-[210px] lg:max-h-[180px] md:max-h-[160px] flex items-end">
          <div className="relative uppercase w-[95%] flex flex-col items-end text-end text-[2.4rem] leading-[1.8rem] font-gotham-black font-bold sm:w-[65%] sm:mx-auto sm:text-[3.4rem] sm:leading-[2.5rem] md:mt-[-16px] md:text-[4.4rem] md:leading-[3.5rem]">
            ...
            <div className="inset-0">
              <div className="absolute h-full top-[-12px] right-[-5px] border-l border-[#8B3A2A] border-1 md:right-[-7px]" />
              <div className="absolute w-full max-w-[9rem] top-0 md:top-[2px] -right-[0.875rem] sm:max-w-[6rem]  md:-right-[1rem] border-t border-[#8B3A2A]  md:border-1 md:w-[13rem] xl:w-[18rem]" />
            </div>
          </div>
        </div>
      </div>
      <div className="relative  mx-auto">
        <div className="absolute w-full h-full bg-[url(/imgs/event-section/image-background-texture.png)] opacity-[0.4] bg-cover bg-center bg-no-repeat" />
            ...
            >
              ...
              <div className="relative p-4 pl-0 space-y-2">
                <div className="hidden sm:block inset-0">
                  <div className="absolute h-[81.5%] top-[12%] left-0 border-l border-[#8B3A2A] border-[1px]" />
                </div>
                ...
                >
                  <div className="hidden sm:block absolute w-[12rem] top-0 left-[-3.4rem] border-t border-[#8B3A2A] border-[1px] " />
                  Inscreva-se
                </a>
              </div>
            </div>
