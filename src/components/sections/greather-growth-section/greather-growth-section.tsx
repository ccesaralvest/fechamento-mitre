...
const GreatherGrowthSection = () => {
  return (
    <section
      id="greather-growth-section"
      className="min-h-screen md:min-h-full sm:pt-[64px] relative"
    >
      <div className="absolute bottom-0 opacity-[0.4] left-0 w-full h-full bg-[url(/imgs/cement-wall.jpeg)] bg-cover bg-bottom z-[-0]" />
      <div className="relative pt-[14px] w-full pl-[27px] md:pl-4 xl:pl-[3rem] -mt-[1rem] min-h-[130px] pb-[18px] font-unineue text-black xl:max-h-[210px] lg:max-h-[180px] md:max-h-[160px] flex flex-row flex-nowrap items-end">
        <div className="w-full max-w-[240px] sm:max-w-[240px] md:ml-[3rem] ml-2 md:mt-[3rem] md:h-full md:max-w-[280px] lg:max-w-[310px] xl:max-w-[400px] flex flex-row items-end">
          <span className="relative uppercase font-adero text-black text-[14px] md:text-[16px] lg:text-[18px] xl:text-[24px] md:mb-[.875rem] md:ml-[0.3rem] lg:ml-[0.5rem] md:p-[4px]">
            ...
            <div className="absolute w-[5rem] sm:w-[12rem] bottom-0 -left-[1.3rem] md:-left-[105px] border-t border-[#8B3A2A] md:border-1 md:w-[13rem] xl:w-[18rem]" />
          </span>
          <div className="absolute h-full top-0 left-[32px] md:left-[62px] xl:left-[91px] border-l border-[#8B3A2A] border-1" />
        </div>
      </div>
...
export default GreatherGrowthSection;
